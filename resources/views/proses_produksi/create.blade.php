...
<div>
  <form method="POST" action="{{ route('proses-produksi.store') }}">
    ...
    <div id="rows-container">
      ...
      <div class="row-item border p-4 mb-4 rounded" data-row-index="1">
        ...
        <div class="collapse-preview text-sm text-gray-700 font-semibold"></div>
            <button type="button" class="toggle-collapse bg-gray-300 hover:bg-gray-400 text-xs px-2 py-1 rounded">Collapse</button>
        </div>
         <div class="row-content">
            <!-- DETAIL JOB -->
            <div class="mb-8">
              <h2 class="font-semibold text-blue-700 mb-3 border-b border-blue-300 pb-1">DETAIL JOB</h2>
              <div class="space-y-2 text-sm">
                <div class="flex items-center">
                  <label class="w-1/3 text-gray-700">Proses</label>
                  <select name="proses[]" class="proses border border-gray-300 rounded-md px-2 py-1 w-2/3">
                ...
                <div class="flex items-center">
                  ...
                  <select name="pengawas[]" class="border border-gray-300 rounded-md px-2 py-1 w-2/3" required>
                ...
                <div class="flex items-center">
                  ...
                  <select name="shift_pengawas[]" class="border border-gray-300 rounded-md px-2 py-1 w-2/3" required>
                ...
                <div class="flex items-center">
                  ...
                  <input type="text" list="job" name="job[]" placeholder="250001..." class="job-input border border-gray-300 rounded-md px-2 py-1 w-2/3">
                  <datalist id="job">
                    @foreach ($jobs as $job)
                ...
                <div class="flex items-center">
                  ...
                  <input type="text" name="product[]" class="product-input border border-gray-300 rounded-md px-2 py-1 w-2/3 bg-gray-100" readonly>
                </div>
                <div class="flex items-center">
                  <label class="w-1/3 text-gray-700">Docket</label>
                  <input type="text" name="designno[]" class="designno-input border border-gray-300 rounded-md px-2 py-1 w-2/3 bg-gray-100" readonly>
                </div>
                <div class="flex items-center">
                  <label class="w-1/3 text-gray-700">PO</label>
                  <input type="text" name="po[]" class="po-input border border-gray-300 rounded-md px-2 py-1 w-2/3 bg-gray-100" readonly>
                </div>
                <div class="flex items-center">
                  <label class="w-1/3 text-gray-700">ORDER (pcs)</label>
                  <input type="number" name="qty[]" class="qty-input border border-gray-300 rounded-md px-2 py-1 w-2/3 font-semibold bg-gray-100">
                </div>
              </div>
            </div>
            ...
            <!-- DETAIL PENGERJAAN -->
            <div class="mb-8">
              <h2 class="font-semibold text-blue-700 mb-3 border-b border-blue-300 pb-1">DETAIL PENGERJAAN</h2>
              <div class="space-y-2 text-sm">
                <div class="flex items-center">
                  <label class="w-1/3">Tanggal</label>
                  <input type="date" name="tanggal[]" class="productionDate border px-2 py-1 w-2/3 rounded-md">
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <select name="mesin[]" class="border px-2 py-1 w-2/3 rounded-md">
                    ...
                    <option>CX</option><option>SM-03</option><option>SAKURAI</option><option>KOMORI</option>
                    <option>LAMINATING</option><option>LAMINASI</option>
                    <option>WATERBASE</option>
                    <option>HOCK</option>
                    <option>HMC-01</option><option>HMC-02</option><option>HMC-03</option><option>HMC-04</option>
                    <option>LABEL</option><option>MANUAL SONGSONG</option><option>MANUAL MONDO</option>
                    <option>LEM AB</option><option>LEM G2</option><option>LEM G3</option><option>LEM G4</option>
                    <option>CUTTING</option><option>MESIN PRETEL</option><option>MANUAL PRETEL</option>
                    <option>POLAR 115</option><option>POLAR 137</option>
                ...
                <div class="flex items-center">
                  ...
                  <div class="operator-wrapper relative w-2/3">
                    ...
                    <input type="text" class="operator-input border px-2 py-1 w-full rounded-md" placeholder="Ketik atau pilih operator..." autocomplete="off">
                    <div class="operator-list border rounded-md mt-1 bg-white shadow hidden max-h-40 overflow-y-auto absolute w-full z-10"></div>
                ...
                <div class="flex items-center tim-section hidden">
                  ...
                  <input name="jumlahtim[]" type="number" class="border px-2 py-1 w-2/3 rounded-md">
                </div>
    
                <div class="flex items-center">
                  <label class="w-1/3">Start Setting</label>
                  <input name="set[]" type="datetime-local" class="set-input border px-2 py-1 w-2/3 rounded-md">
                </div>
                <div class="flex items-center">
                  <label class="w-1/3">Start Running</label>
                  <input name="run[]" type="datetime-local" class="run-input border px-2 py-1 w-2/3 rounded-md">
                </div>
                <div class="flex items-center">
                  <label class="w-1/3">Finish Running</label>
                  <input name="finish[]" type="datetime-local" class="finish-input border px-2 py-1 w-2/3 rounded-md">
                </div>
            ...
            <!-- DETAIL OUTPUT -->
            <div class="mb-8">
              <h2 class="font-semibold text-blue-700 mb-3 border-b border-blue-300 pb-1">DETAIL OUTPUT</h2>
              <div class="space-y-2 text-sm">
                <div class="flex items-center">
                  <label class="w-1/3">UP SPK</label>
                  <input class="upspk-input border px-2 py-1 w-2/3 rounded-md" name="upspk[]" type="number">
                </div>
    
                <div class="flex items-center">
                  <label class="w-1/3">Keterangan</label>
                  <input type="text" name="ket[]" class="border px-2 py-1 w-2/3 rounded-md">
                </div>
    
                <div class="box-section hidden space-y-2 text-sm">
                  <div class="flex items-center">
                    <label class="w-1/3">BOX</label>
                    <input name="box[]" type="text" class="box-input border px-2 py-1 w-2/3 rounded-md">
                  </div>
                  <div class="flex items-center">
                    <label class="w-1/3">ISIBOX</label>
                    <input name="isibox[]" type="text" class="isibox-input border px-2 py-1 w-2/3 rounded-md">
                  </div>
                  <!-- TAMBAHAN BARU -->
                  <div class="flex items-center">
                ...
                <div class="flex items-center">
                  <label class="w-1/3">Input (DRIK)<sup class="text-red-600"> *Jika LEM, Input = PCS</sup></label>
                  <input name="input[]" type="text" class="input-drk border px-2 py-1 w-2/3 rounded-md">
                </div>
                ...
                <div class="sortpacking-section hidden space-y-2 text-sm">
                  <div class="flex justify-between items-center mb-2">
                    ...
                    <button type="button" class="add-jt-btn bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-600 text-xs">+ Add JT</button>
                  </div>
                  ...
                  <div class="flex items-center">
                    ...
                    <input type="number" name="sortirpcs[]" class="sortirpcs-input border px-2 py-1 w-2/3 bg-gray-100" readonly>
                  </div>
    
                  <div class="flex items-center">
                    <label class="w-1/3">Sortir Drik</label>
                    <input type="number" name="sortirdrik[]" class="sortirdrik-input border px-2 py-1 w-2/3 bg-gray-100" readonly>
                  </div>
    
                  <div class="flex items-center">
                    <label class="w-1/3">Packing PCS</label>
                    <input type="number" name="packingpcs[]" class="packingpcs-input border px-2 py-1 w-2/3 bg-gray-100" readonly>
                  </div>
    
                  <div class="flex items-center">
                    <label class="w-1/3">Packing Drik</label>
                    <input type="number" name="packingdrik[]" class="packingdrik-input border px-2 py-1 w-2/3 bg-gray-100" readonly>
                  </div>
                </div>
    
                <div class="flex items-center">
                  <label class="w-1/3">JT Drik</label>
                  <input type="number" name="jtdrik[]" class="jtdrik-input border px-2 py-1 w-2/3 rounded-md">
                </div>
    
                <div class="flex items-center">
                  <label class="w-1/3">JS PCS</label>
                  <input type="number" name="jtpcs[]" class="jtpcs-input border px-2 py-1 w-2/3 bg-gray-100 rounded-md">
                </div>
    
                <div class="flex items-center">
                  <label class="w-1/3">Output Drik</label>
                  <input type="number" name="outputdrik[]" class="outputdrik-input border px-2 py-1 w-2/3 font-semibold bg-gray-100 rounded-md" readonly>
                </div>
    
                <div class="flex items-center">
                  <label class="w-1/3">Output Pcs</label>
                  <input type="number" name="outputpcs[]" class="outputpcs-input border px-2 py-1 w-2/3 font-semibold bg-gray-100 rounded-md" readonly>
                </div>
    
                <div class="flex items-center">
                  <label class="w-1/3">Target Drik/Hour</label>
                  <input type="number" name="target[]" class="border px-2 py-1 w-2/3 font-semibold rounded-md">
                </div>
              </div>
            </div>
        </div>
    ...
    <!-- Tombol Add Row -->
    <div class="mt-4">
      <button type="button" id="add-row-btn" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600">+ Add Row</button>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initRow(row) {
    ...
    [setInput, runInput, finishInput].forEach(input => { input?.setAttribute('max', maxDatetime); });
  ...
  if (setTime > finishTime) hasError = true;
    ...
    [setInput, runInput, finishInput].forEach(input => input?.addEventListener('change', validateOrder));

    // ===== format angka (sama persis) =====
    // convert number inputs to text with formatting
    const numberInputs = row.querySelectorAll('input[type="number"], input.input-drk, input.upspk-input, input.jtdrik-input, input.jtpcs-input, input.box-input, input.isibox-input');
    ...
    function updateOperatorList(filteredOptions, keyword = '') {
      ...
      if (shown.length === 0) { operatorList.classList.add('hidden'); return; }
      shown.forEach(opt => {
    ...
    function updateBadges() {
      ...
      selectedOperators.forEach(name => {
        ...
        badge.className = 'bg-blue-200 text-blue-800 px-2 py-1 rounded flex items-center gap-1';
        badge.innerHTML = `${name} <span class="cursor-pointer font-bold" data-name="${name}">&times;</span>`;
    ...
    function filterOperators() {
      ...
      switch (selectedProses) {
        case 'PRINT': targetBagian = 'PRINTING'; break;
        case 'WATERBASE':
        case 'LAMINASI':
        case 'LAMINATING':
        case 'HOCK':
          targetBagian = ['COATING', 'LAMINASI', 'LAMINATING']; break;
        case 'HOTPRINT':
        case 'EMBOSS':
        case 'DIECUT': targetBagian = 'DIECUT'; break;
        case 'CUTTING': targetBagian = 'CUTTING'; break;
        case 'PRETEL': targetBagian = 'PRETEL'; break;
        case 'LEM':
        case 'LEM SETENGAH JADI':
          targetBagian = 'FINISHING'; targetGender = 'LAKI-LAKI'; break;
        case 'SORTPACKING':
          targetBagian = 'FINISHING'; targetGender = 'PEREMPUAN'; break;
        default: targetBagian = null;
      }
    ...
    operatorInput?.addEventListener('input', e => {
      ...
      if (keyword.length === 0) { operatorList.classList.add('hidden'); return; }
      ...
      fetch(`/get-job-data/${jobId}`)
        ...
        .then(data => {
          if (data) {
            ...
            qtyInput.value = (data.qty !== undefined && data.qty !== null) ? data.qty.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.') : '';
          } else {
            productInput.value = '';
            designnoInput.value = '';
            poInput.value = '';
  ...
  document.querySelector('form')?.addEventListener('submit', (ev) => {
    ...
    document.querySelectorAll('input').forEach(inp => {
      ...
      const checkNames = ['input[]','upspk[]','jtdrik[]','jtpcs[]','sortirpcs[]','sortirdrik[]','packingpcs[]','packingdrik[]','outputdrik[]','outputpcs[]','qty[]'];
      // Accept also non-suffixed names if present
      if (name && (checkNames.includes(name) || checkNames.some(n => name.startsWith(n.replace('[]',''))))) {
